...
# Each entry backs a claim CLAUDE.md typically makes about this workflow. INIT
# appends project-specific paths (build config, CI workflow files, source dirs)
# so drift in those is caught too.
WATCHED = (
